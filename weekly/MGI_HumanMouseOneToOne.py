...
'''
# Name: MGI_HumanMouseOneToOne.py
#
...
# 10: Mouse gene symbol from allele in column 6/7
# 11: Mouse gene ID
# 12: Repository ID for gene (if available, can be null)
#
# History:
#
# lec   01/23/2023
...
def initialize():
        ...
        results = db.sql('''
                select a.accID as doID, aa.accID as genotypeID
        ...
        for r in results:
                key = r['doID']
                value = r['genotypeID']
                if key not in genotypeLookup:
                        genotypeLookup[key] = []
                genotypeLookup[key].append(value)
        #print(genotypeLookup)
...
def processReport1():
        ...
        # report 1
        fp1 = reportlib.init('MGI_HumanMouseOneToOne1', outputdir = os.environ['REPORTOUTPUTDIR'], printHeading = None)
        ...
        for r in results:
                ...
                if doID in genotypeLookup:
                        fp1.write('|'.join(genotypeLookup[doID]))
                fp1.write(TAB)
...
def processReport2():
        ...
        # report 2
        fp2 = reportlib.init('MGI_HumanMouseOneToOne2', outputdir = os.environ['REPORTOUTPUTDIR'], printHeading = None)
