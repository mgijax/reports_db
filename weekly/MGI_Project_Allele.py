...
# official nomenclature for all KOMP, EUCOMM, NorCOMM alleles in MGI db 
# (this includes ES Cells and mice being generated by each project).
#
...
#
# lec	04/24/2012
#	- TR11035/postgres cleanup
#	- combine KOMP, EUCOMM, NorCOMM into one report
#
# lec	03/12/2010
#	- created, TR 9207
#
...
fp.write('#\n')
fp.write('# This report lists the official nomenclature for all KOMP, EUCOMM, NorCOMM alleles in MGI\n')
fp.write('#\n')
...
#
# select all KOMP, EUCOMM, NorCOMM alleles
#

db.sql('''
	select a._Allele_key, a._Marker_key, a.symbol, a.name,
...
db.sql('create index idx1 on #project(_Allele_key)', None)
db.sql('create index idx2 on #project(_Marker_key)', None)
...
results = db.sql('''select k._Allele_key, a.accID 
      from #project k, ACC_Accession a 
...
results = db.sql('''select distinct k._Allele_key, a.accID
	from #project k, ALL_Allele_CellLine c, ACC_Accession a
...
# process results
#
results = db.sql('select * from #project order by projectID', 'auto')
