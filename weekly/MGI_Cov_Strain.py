...
fp.write('#\n')
fp.write('# This report contains mouse strains used in coronavirus research references in MGI.\n')
fp.write('# When available Human Disease Ontology (DO) and system-level Mammalian Phenotype ontology (MP) annotations for the strain are included.\n')
