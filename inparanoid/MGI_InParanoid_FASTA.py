...
def initialize():
    ...
    # deleted sequences
    db.sql('select s._Sequence_key into temporary table deletedsequences ' + \
	    'from SEQ_Sequence s ' + \
    ...
    db.sql('select distinct m._Marker_key into temporary table excludemarkers ' + \
    ...
    #
    db.sql('select s.accID, s._Marker_key, s._Qualifier_key into temporary table sequences ' + \
